          ...
          <div className='grid grid-cols-1 gap-4'>
            <div className='flex items-center justify-between'>
              ...
              <div className='hidden lg:flex items-center justify-end md:space-x-4 lg:space-x-6'>
                ...
                <Link href="/test" className='flex font-semibold items-center px-2 py-2 rounded-xl text-sm text-white uppercase'>
                  <Image src={IconDifferent} alt='Somos Different' className='max-w-full h-5 mr-1' />
                  Somos different
                </Link>
                <i className='separator'></i>
